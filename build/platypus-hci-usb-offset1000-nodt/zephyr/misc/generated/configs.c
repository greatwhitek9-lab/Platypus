...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SAMPLE_USBD_PID, 0x000B);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_WORLDSEMI_WS2812_GPIO_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DELAY_T0H, 19);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DELAY_T1H, 38);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DELAY_T0L, 58);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DELAY_T1L, 38);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_HELTEC_T114_V2, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_HELTEC_T114_V2_NRF52840_UF2, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR_RX_POLL, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR_PARAM_CHECK, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR_LLID_DATA_START_EMPTY, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR_THROUGHPUT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR_FORCE_MD_COUNT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR_FORCE_MD_AUTO, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_USBD_BT_HCI, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_USBD_BT_HCI_TX_THREAD_PRIORITY, 8);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_USBD_BT_HCI_TX_STACK_SIZE, 512);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_USBD_BT_HCI_RX_THREAD_PRIORITY, 8);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_FLASH_LOAD_SIZE, 0xdf000);
